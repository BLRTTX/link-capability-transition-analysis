...
**必须先安装语雀MCP或语雀Skill**,才能使用本Skill读取语雀文档。

### 方式1: 安装语雀Skill(推荐)

访问语雀Skill详情页面:
https://skill.antgroup-inc.cn/skills/@antskill/yuque
...
安装完成后,语雀相关工具将自动可用,Agent可以直接调用语雀工具读取文档。

...
**必须先安装语雀Skill**,才能使用本Skill读取语雀文档。

### 安装语雀Skill

安装命令:
```bash
tnpx @antskill/agentic-installer @antskill/yuque
```

语雀Skill详情: https://skill.antgroup-inc.cn/skills/@antskill/yuque?tab=files
...
2. **Agent调用语雀Skill** - 使用语雀Skill提供的MCP工具读取文档
